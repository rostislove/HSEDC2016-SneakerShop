...
class SneakersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sneaker" do
    assert_difference('Sneaker.count') do
      post sneakers_url, params: { sneaker: { brand_id: @sneaker.brand_id, name: @sneaker.name, price: @sneaker.price, sex: @sneaker.sex, size: @sneaker.size } }
    end
  ...
  test "should update sneaker" do
    patch sneaker_url(@sneaker), params: { sneaker: { brand_id: @sneaker.brand_id, name: @sneaker.name, price: @sneaker.price, sex: @sneaker.sex, size: @sneaker.size } }
